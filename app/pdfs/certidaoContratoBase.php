        ...
        <table border="1" cellspacing="0" cellpadding="10" width="100%" class="" style="color: var(--primary)">
          <thead>
            <tr class="text-center" style="color: #fff; background-color: #003333;">
              <th class="text-center text-uppercase" style="text-transform: uppercase;" scope="col">Exercício</th>
              <th class="text-center text-uppercase" style="text-transform: uppercase;" scope="col">Data da Portaria</th>
              <th class="text-center text-uppercase" style="text-transform: uppercase;" scope="col">Tipo da Portaria</th>
              <th class="text-center text-uppercase" style="text-transform: uppercase;" scope="col">Agente</th>
              <th class="text-center text-uppercase" style="text-transform: uppercase;" scope="col">Cargo</th>
            </tr>
          </thead>
          <tbody>
